...
import { ImageUploader } from '@/components/UI/UploadImageFirebase'

export const CreateCourseModal = ({ onClose }: { onClose: () => void }) => {
    const [formData, setFormData] = useState<Omit<CreateCourse, 'id'>>({ description: '', image_url: '', level: '', title: '' })
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="col-span-2">
                            <ImageUploader imageUrl={formData.image_url} onChange={(url) => setFormData({ ...formData, image_url: url })} />
                        </div>
